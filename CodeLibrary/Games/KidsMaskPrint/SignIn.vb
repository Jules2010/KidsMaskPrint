...
#Region "Friend Properties"
    ...
    Friend Property SelectedUser() As String
        ...
        End Set
    End Property
    Dim mUICol1 As Color 'JM 24/09/2004
    Friend ReadOnly Property UICol1() As Color 'JM 24/09/2004
        Get
            Return mUICol1
        End Get
    End Property
    Dim mUICol2 As Color 'JM 24/09/2004
    Friend ReadOnly Property UICol2() As Color 'JM 24/09/2004
        Get
            Return mUICol2
        End Get
    End Property
    Friend Enum Params 'JM 26/09/2004
        None
        NewRequired
    End Enum
    Dim mParam As Params = Params.None 'JM 26/09/2004
    Friend ReadOnly Property Param() As Params 'JM 26/09/2004
        Get
            Return mParam
        End Get
    End Property
...
#End Region
    ...
    Private listBoxBrushes() As Brush 'JM 02/09/2004
    Private lGradeCol1(4) As Color 'JM 02/09/2004
    Private lGradeCol2(4) As Color 'JM 02/09/2004
    ...
    Private Sub SignIn_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.SuspendLayout() 'JM 07/09/2004

        AddDebugComment("SignIn.SignIn_Load - start") 'JM 07/09/2004
        ...
        Dim lbooButtonsAdded As Boolean = False 'JM 06/09/2004

        Dim xx() As BevelButton

        'If lstrUsersStr <> "" Then
        lstrUsersStr = ReplaceAll(lstrUsersStr, ChrGet(255) & ChrGet(255), ChrGet(255)) 'JM 06/09/2004

        If RightGet(lstrUsersStr, 1) = ChrGet(255) Then 'JM 07/09/2004
        ...
        If lstrUsersStr <> "" Then
            ...
            Dim PositionArr(mUsers.GetUpperBound(0)) As Point 'JM 17/08/2004
            ...
            ReDim xx(mUsers.GetUpperBound(0)) 'JM 06/09/2004
            ...
            For lintArrInc = 0 To xx.GetUpperBound(0)
                ...
                With xx(lintArrInc)
                    ...
                    lbooButtonsAdded = True 'JM 06/09/2004
                End With
            Next lintArrInc
        ...
        If lbooButtonsAdded = True Then 'JM 06/09/2004
            ...
            Panel2.Height = GreatestHeight + FirstBtnHeight + 24 + 72 + 10 + 50 'JM 02/09/2004
            'Panel1.Top = GreatestHeight + FirstBtnHeight + FirstBtnTop
            Me.Height = Panel2.Top + Panel2.Height + 30 'JM 02/09/2004
        ...
        'SetBrushes() 'JM 02/09/2004
        'lbListBox.SelectedIndex = 0 'JM 02/09/2004

        Me.Location = CentreMe(Me) 'JM 09/09/2004

        Busy(Me, False) 'JM 21/09/2004

        AddDebugComment("SignIn.SignIn_Load - end") 'JM 07/09/2004

        Me.ResumeLayout() 'JM 07/09/2004

    End Sub
    Private Sub NameBtnOnClick(ByVal sender As Object, ByVal e As EventArgs)

        AddDebugComment("SignIn.NameBtnOnClick - start") 'JM 07/09/2004

        lbListBox.Items.Clear() 'JM 26/09/2004
        SetBrushes() 'JM 02/09/2004

        mSelectedUser = sender.text
        lblName.Text = mSelectedUser 'JM 02/09/2004

        lbListBox.Text = GetSetting("Colours", "One", InitalXMLConfig.XmlConfigType.UserSettings, mSelectedUser)


        lbListBox.Enabled = True 'JM 02/09/2004
        'Me.Close()

        AddDebugComment("SignIn.NameBtnOnClick - end") 'JM 07/09/2004

    End Sub
    Private Sub btnHelp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

        AddDebugComment("SignIn.btnHelp_Click") 'JM 07/09/2004
        'JM 24/08/2004
    ...
    Private Sub btnOKClick_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOKClick.Click
        ...
        AddDebugComment("SignIn.btnOKClick_Click - start") 'JM 07/09/2004
    ...
    Private Sub SetBrushes()
        ...
        AddDebugComment("SignIn.SetBrushes - start") 'JM 07/09/2004

        Me.lbListBox.Items.AddRange(New Object() {"One", "Two", "Three", "Four", "Five"}) 'JM 06/09/2004
        ...
        AddDebugComment("SignIn.SetBrushes - end") 'JM 07/09/2004
    ...
    Private Sub lbListBox_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbListBox.SelectedIndexChanged
        ...
        AddDebugComment("SignIn.lbListBox_SelectedIndexChanged") 'JM 07/09/2004

        'added 'JM 02/09/2004
        'UIStyle.gPaintClr1 = lGradeCol1(lbListBox.SelectedIndex)
        'UIStyle.gPaintClr2 = lGradeCol2(lbListBox.SelectedIndex)
        mUICol1 = lGradeCol1(lbListBox.SelectedIndex) 'JM 24/09/2004
        mUICol2 = lGradeCol2(lbListBox.SelectedIndex) 'JM 24/09/2004
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        mParam = Params.NewRequired 'JM 26/09/2004
        Me.Close()
        ''Dim NU As New NewUser() 'JM 21/09/2004
        ''NU.Owner = Me
        ''NU.ShowDialog()
